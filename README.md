...
Project Overview:
The project is not broken up into separate distinct blocks (but can easily be run and converted into a .ipynb). 
...
To run, execute the cells sequentially in the .ipynb –– that's it!
